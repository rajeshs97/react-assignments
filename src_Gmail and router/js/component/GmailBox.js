...
getmsgIDS: function(messageID)
  {
    var accessToken = localStorage.getItem('gToken');
    $.ajax({
      url: 'https://www.googleapis.com/gmail/v1/users/rajr76572%40gmail.com/messages?labelIds='+messageID+'&maxResults=20&key={AIzaSyCtNDr9ikNZx04UVpcBuUXRoNTAAoAqbAo}',
      dataType: 'json',
      type: 'GET',
      async:false,
      beforeSend: function (request)
...
getInbox: function(id)
{
  //console.log(id);
    var accessToken = localStorage.getItem('gToken');
var r=$.ajax({
     url: 'https://www.googleapis.com/gmail/v1/users/rajr76572%40gmail.com/messages/'+id+'?key={AIzaSyCtNDr9ikNZx04UVpcBuUXRoNTAAoAqbAo}',//key and json object url
     dataType: 'json',
     type: 'GET',
     async:false,
     beforeSend: function (request)
 ...
 render:function()
 {
   ...
   if(loadedData){
     leftPanel =  <LeftPanel allLabelsData={this.state.allLabelsData} messageID={this.getmsgIDS}/>
